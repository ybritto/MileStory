...
- [x] 02-03-PLAN.md — Ship the guided Angular goal planning, detail, and archive flow
...
- [x] 03-03-PLAN.md — Ship the goal-detail progress-entry UX, history, and pace rendering
